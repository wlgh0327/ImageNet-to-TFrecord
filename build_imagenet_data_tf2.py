...
tf.compat.v1.app.flags.DEFINE_string('train_directory', None,
                           'Training data directory')

tf.compat.v1.app.flags.DEFINE_string('validation_directory', None,
...
tf.compat.v1.app.flags.DEFINE_integer('validation_shards', 1,
